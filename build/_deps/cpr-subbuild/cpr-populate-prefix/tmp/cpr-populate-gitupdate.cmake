...
execute_process(
  COMMAND "/usr/bin/git" show-ref "0817715923c9705e68994eb52ef9df3f6845beba"
  WORKING_DIRECTORY "/home/aidan/Projects/botdogs-scout/build/_deps/cpr-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/aidan/Projects/botdogs-scout/build/_deps/cpr-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/aidan/Projects/botdogs-scout/build/_deps/cpr-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
